...
| `spec-drift` | `tests/AiPMOInsight.Api.Tests/OpenApiDriftTest.cs`, `tests/AiPMOInsight.Api.Tests/OpenApiRuntimeContractTest.cs`, `.github/workflows/ci.yml`, `.github/workflows/doc-drift-on-demand.yml`, `source/AiPMOInsight.Api/Program.cs` (schema-name transformer + `AddOpenApi` block) |
