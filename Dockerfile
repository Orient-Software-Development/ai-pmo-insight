...
COPY source/ source/
RUN dotnet restore source/AiPMOInsight.Api/AiPMOInsight.Api.csproj
RUN dotnet publish source/AiPMOInsight.Api/AiPMOInsight.Api.csproj \
...
ENTRYPOINT ["dotnet", "AiPMOInsight.Api.dll"]
